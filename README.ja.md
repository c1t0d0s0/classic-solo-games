...
- **日本の麻雀牌に完全統一**: 萬子（1〜9萬）、筒子（1〜9筒）、索子（1〜9索）、風牌（東・南・西・北）、三元牌（白・發・中）の日本式麻雀牌のみで構成された144牌ピラミッド（タートル配置）。
- **リアルな3D彫刻グラフィック**: 1筒の花車文様、1索の孔雀、無地の白、翡翠（ジェイド）グリーンの背張り、段数に応じた立体ドロップシャドウを再現。
